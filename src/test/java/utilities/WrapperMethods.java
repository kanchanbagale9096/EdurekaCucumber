...
public class WrapperMethods {
	...
	public void Clickbtn(WebDriver driver, String ObjectxPath, String Element_Name) throws Exception {

		System.out.println("inside wrapper click button method");
		...
		try {
			...
			webButton.click();
			// Extent_Reporting.Log_Pass(Element_Name + " Clicked", Element_Name + "
			// Clicked");
		} catch (Throwable e) {
			// Extent_Reporting.Log_Fail(Element_Name + " does not Exist", Element_Name + "
			// does not Exist", screenName);
			System.out.println(e.getMessage());
			throw new Exception("Element Not Present");
		}
	}

	public void inputText(WebDriver driver, String ObjectxPath, String sValue, String Element_Name) throws Exception {
		try {
			WebElement inputText = driver.findElement(By.xpath(ObjectxPath));
			inputText.clear();
			inputText.sendKeys(sValue);
			// Extent_Reporting.Log_Pass(Element_Name + " Entered", sValue + " entered in "
			// + Element_Name);
		} catch (Throwable t) {
			// Extent_Reporting.Log_Fail(Element_Name + " does not Exist", Element_Name + "
			// does not Exist", screenName);
	...
	public WebElement findElementPresentByXpath(String xpath, WebDriver driver, String Element_Name)
			throws InterruptedException {
		try {
			driver.findElement(By.xpath(xpath));
			Extent_Reporting.Log_Pass(Element_Name + " Exist", Element_Name + " Exist");
	...
	public void inputText_Enter_By_cssSelector(WebDriver screenName, String ObjectxPath, String sValue,
	...
	public void sendkeys_enter(WebDriver screenName, String ObjectxPath, String Element_Name) throws Exception {
		try {
			...
			// Extent_Reporting.Log_Pass(Element_Name+" Entered" + " entered in "+
			// Element_Name);
		} catch (Throwable t) {
			Extent_Reporting.Log_Fail(Element_Name + " does not Exist", Element_Name + " does not Exist", screenName);
			t.printStackTrace();
	...
	public boolean isElementPresentByXpathAndClick(String xpath, WebDriver driver, String Value, String Element_Name)
			throws InterruptedException {
		try {
	...
	public void isnullandEnter(WebDriver screenName, String ObjectxPath, String sValue, String Element_Name)
			throws Exception {
		try {
	...
	public void isnullandclick(WebDriver screenName, String ObjectxPath, String xpathExpression, String Element_Name)
			throws Exception {
		try {
			String webButton = screenName.findElement(By.xpath(ObjectxPath)).getAttribute("value");
	...
	public void inputText_Enter(WebDriver screenName, String ObjectxPath, String sValue, String Element_Name)
			throws Exception {
		try {
			WebElement inputText = screenName.findElement(By.xpath(ObjectxPath));
			inputText.sendKeys(sValue, Keys.ENTER);
	...
	public void clearAndInputTextValue(WebDriver screenName, String ObjectxPath, String value, String Element_Name)
		...
		try {
			...
			Extent_Reporting.Log_Pass(Element_Name + " cleared & Entered with " + value,
	...
	public void selectDropBoxValue(WebDriver screenName, String ObjectxPath, String value, String Element_Name)
		...
		try {
			...
			Extent_Reporting.Log_Pass(Element_Name + " selected with " + value,
					Element_Name + " selected with " + value);
		} catch (Throwable t) {
			Extent_Reporting.Log_Fail(Element_Name + " does not Exist", Element_Name + " does not Exist", screenName);
			t.printStackTrace();
			throw new Exception("Element Not Present");
	...
	public void isnullandselectDropBoxValue(WebDriver screenName, String ObjectxPath, String Value, String Element_Name)
			throws Exception {
		try {
	...
	public void selectDropBoxValue(WebDriver screenName, String ObjectxPath, int index, String Element_Name)
		...
		try {
			...
			Extent_Reporting.Log_Pass(Element_Name + " selected with " + index,
					Element_Name + " selected with " + index);
		} catch (Throwable t) {
			Extent_Reporting.Log_Fail(Element_Name + " does not Exist", Element_Name + " does not Exist", screenName);
			t.printStackTrace();
			throw new Exception("Element Not Present");
	...
	public void selectDropBoxDefaultValue(WebDriver screenName, String ObjectxPath, String Element_Name)
		...
		try {
			...
			Extent_Reporting.Log_Pass(Element_Name + " selected with default value ",
	...
	public String getDropBoxDefaultValue(WebDriver screenName, String ObjectxPath, String Element_Name)
		...
		try {
			WebElement selectDropBox = screenName.findElement(By.xpath(ObjectxPath));
			Select select = new Select(selectDropBox);
			Extent_Reporting.Log_Pass(Element_Name + " selected value is " + select.getFirstSelectedOption().getText(),
	...
	public int getDropBoxSize(WebDriver screenName, String ObjectxPath, String Element_Name) throws Exception {
		try {
			WebElement selectDropBox = screenName.findElement(By.xpath(ObjectxPath));
			Select select = new Select(selectDropBox);
			Extent_Reporting.Log_Pass(Element_Name + " dropbox size is " + select.getOptions().size(),
	...
	public int getElementCount(WebDriver driver, String className, String Element_Name) throws Exception {
		...
		try {
			...
			Extent_Reporting.Log_Pass(Element_Name + " element count " + count,
					Element_Name + " element size is " + count);
		} catch (Throwable t) {
			Extent_Reporting.Log_Fail(Element_Name + " does not Exist", Element_Name + " does not Exist", driver);
			t.printStackTrace();
			throw new Exception("Element Not Present");
	...
	public void mouseHoverAction_3(WebDriver driver, String mainElementXP, String subElementXP, String subSubElementXP,
		...
		try {
			...
			Extent_Reporting.Log_Pass("Click action is performed on the selected Product Type" + Element_Name,
	...
	public void selectWindowIfElementPresent(WebDriver driver, String element) throws InterruptedException {
		...
		if (isElementDisplay(driver, element)) {
			Extent_Reporting.Log_Pass("Selected Pop Up : " + driver.switchTo().window(win[0].toString()).getTitle(),
	...
	public void waitForElementVisibleandenter(WebDriver driver, String xpath, String element, String Element_Name)
			throws Throwable {
		try {
...
*/
	...
	public void Clickbtn2(WebDriver screenName, String ObjectxPath, String Element_Name) throws Exception {
		...
		try {
			...
			// Extent_Reporting.Log_Fail(Element_Name+" does not Exist",Element_Name+" does
			// not Exist", screenName);
			// t.printStackTrace();
			throw new Exception("Element Not Present");
		}
	}
...
/*
	public boolean CheckifTextExistwithoutReport(WebDriver driver, String element, String Element_Name)
		...
		try {
			...
			String Strelement = "//*[contains(text(),'" + element + "')]";
			driver.findElement(By.xpath(Strelement));
			// Extent_Reporting.Log_Pass(Element_Name + " Exist", Element_Name + " is
			// Exist");
			System.out.println("Element Exist");
			// return true;
			// driver.switchTo().defaultContent();
...
*/
	...
	public void javascriptExecutor_Scroll(WebDriver driver, String XpathObject, String ObjectName) {
		try {
			...
			System.out.println("wrapper Inside Scroll()");
			...
			// Extent_Reporting.Log_Fail(ObjectName+" Not Present", ObjectName+" Not
			// Present", driver);
			t.printStackTrace();
			new Exception(ObjectName + " not present");
		}
